  ...
  <div class="landing grid grid-cols-12 gap-2 text-gray-700">
    ...
    <div class="col-span-8 p-4">
      <div class="flex items-center">
        ...
        <div class="flex-1">
          <img src="~/assets/school-childrens.png" alt="Geoqi" />
        </div>
      </div>

      <!-- Bullets & Quick links for Rural School Mapping-->
      <div class="py-4 rounded-md bg-blue-500 bg-opacity-10">
        <div class="px-6 pb-4 font-semibold text-xl font-lg">
        ...
        <div class="flex items-start px-4">
          ...
          <div class="flex-1 text-right">
            ...
            <div class="mb-2 text-sm hover:text-blue-700 hover:underline">
              <nuxt-link to="/objective">Objective</nuxt-link>
            </div>
            <div class="mb-2 text-sm hover:text-blue-700 hover:underline">
            ...
            <div class="mb-2 text-sm hover:text-blue-700 hover:underline">
              <nuxt-link to="/results-portal">Rural Schools Portal</nuxt-link>
            </div>
            <div class="mb-2 text-sm hover:text-blue-700 hover:underline">
              <nuxt-link to="/project-trials">Project trials</nuxt-link>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="py-4 mt-4 rounded-md bg-blue-500 bg-opacity-10">
        <div class="px-6 pb-4 font-semibold text-xl font-lg">
          Hospital Detection
        </div>
        <div class="flex items-start px-4">
          ...
          <div class="flex-1 text-right">
            <div class="text-xl font-medium mb-4">Quick Links</div>
            <div class="mb-2 text-sm hover:text-blue-700 hover:underline">
              <nuxt-link to="/data-pipeline-training-and-inference"
                >Data Pipeline, Training, and Inference</nuxt-link
              >
            </div>
            <div class="mb-2 text-sm hover:text-blue-700 hover:underline">
              <nuxt-link to="/geospatial-hospital-detection"
                >Geospatial Hospital Detection</nuxt-link
              >
            </div>
            <div class="mb-2 text-sm hover:text-blue-700 hover:underline">
              <nuxt-link to="/input-data-files">Input data files</nuxt-link>
            </div>
            <div class="mb-2 text-sm hover:text-blue-700 hover:underline">
              <nuxt-link to="/model-weights">Model Weights</nuxt-link>
            </div>
          </div>
        </div>
      </div>
